...
from SherControl_Scripts_stable import *
from math import pi
...
f = open('v.txt', 'w')
f.close()
f = open('Erfx.txt', 'w')  # size: 3x1
f.close()
f = open('ePOS1.txt', 'w')  # size: 3x1
f.close()
f = open('TaoA.txt', 'w')  # size: 3x1
f.close()
f = open('TaoH.txt', 'w')  # size: 3x1
f.close()
f = open('TaoK.txt', 'w')  # size: 3x1
f.close()
f = open('ZaiE.txt', 'w')  # size: 4x1
f.close()
f = open('fa.txt', 'w')
f.close()
f = open('dfa.txt', 'w')
f.close()
f = open('Zais.txt', 'w')  # size: 4x1
f.close()
f = open('C.txt', 'w')  # size: 4x1
f.close()
f = open('JI.txt', 'w')  # size: 4x1
f.close()
f = open('drb.txt', 'w')  # size: 4x1
f.close()
f = open('wb.txt', 'w')  # size: 4x1
f.close()
f = open('fh.txt', 'w')  # size: 4x1
f.close()
f = open('dfh.txt', 'w')  # size: 4x1
f.close()
f = open('fk.txt', 'w')  # size: 4x1
f.close()
f = open('dfk.txt', 'w')  # size: 4x1
f.close()
f = open('qPC.txt', 'w')  # size: 4x1
f.close()
f = open('gpsFL.txt', 'w')  # size: 4x1
f.close()
# Initial states
